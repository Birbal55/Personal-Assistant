...

{
	...
	do 
	{
		...
		cout<<"********************************************************"<<endl<<endl;
		string phrase="HELLO I AM JARVIS! YOUR PERSONAL ASSISSTSNT, PLEASE ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER BIRBAL";
		string command= "espeak \"" + phrase + "\"";
		const char *charCommand=command.c_str();
		system(charCommand);
		...
		if(password=="birbal")
		{
			...
			{
				cout<<"\n<**************************************************>\n\n";
				cout<<endl<<"How can I help you Master Birbal...."<<endl<<endl;
				
				string phrase="I am Jarvis! How can I help you Master Birbal";
				string command= "espeak \"" + phrase + "\"";
				const char *charCommand=command.c_str();
				system(charCommand);
				...
				{
					cout<<"I am Jarvis created by Master Birbal !!!"<<endl;
				    string phrase="I am  Jarvis created by Master Birbal !!!";
			      	string command= "espeak \"" + phrase+ "\"";
					const char *charCommand=command.c_str();
			    	system(charCommand);
				}
				...
				else if(command=="open notepad")
				{
					...
					const char *charCommand=command.c_str();
			    	system(charCommand);
			    	CreateProcess(TEXT("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Word.lnk"),NULL,NULL,NULL,FALSE,NULL,NULL,NULL,&startInfo,&processInfo);
				}
				...
				else if(command=="open Microsoft Excel")
				{
					...
					const char *charCommand=command.c_str();
			    	system(charCommand);
			    	CreateProcess(TEXT("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Excel.lnk"),NULL,NULL,NULL,FALSE,NULL,NULL,NULL,&startInfo,&processInfo);
				}
				...
				else if(command=="open Microsoft Paint")
				{
					...
					const char *charCommand=command.c_str();
			    	system(charCommand);
			    	CreateProcess(TEXT("c:\\Windows\\System64\\mspaint.exe"),NULL,NULL,NULL,FALSE,NULL,NULL,NULL,&startInfo,&processInfo);
				}
				...
				else if(command=="play music")
				{
					...
					const char *charCommand=command.c_str();
			    	system(charCommand);
			    	mciSendString("open\"D:\\Music\\01 - Satyamev Jayate.mp3",NULL,0,NULL);
					mciSendString("play mp3",NULL,0,NULL);
				
				
					
				}*/
				else if(command=="open chrome browser")
				{
				    cout<<"openining chrome browser"<<endl;
                    string phrase = "opening chrome browser";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("start https://C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Google Chrome.lnk");
				}
				...
				else if (command=="close google")
				{
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("TASKKILL /IM google.exe /F");
				}
				...
				else if(command=="close youtube")
				{
					cout<<"closing youtube"<<endl;
                    string phrase = "closing youtube";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("TASKKILL /IM youtube.exe /F");
				}
				...
				else if(command=="open photo")
				{
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open", "D:\\images\\20211230_071905.jpg",NULL, NULL, SW_NORMAL);
				}
				else if(command=="close photo")
				{
					cout<<"closing photo"<<endl;
                    string phrase = "closing photo";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("TASKKILL /IM  D:\\images\\20211230_071905.jpg /F");
				}
				...
				else if(command=="open video")
				{
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","D:\\AntimThe.Final.Truth.2021.480p.Hindi.WEBDL.ESub.x264NFTMoviez.xyz.mkv",NULL, NULL, SW_NORMAL);
                
				}
				else if(command=="bye" || command=="exit")
				{
					 cout<<"Good Bye Master Birbal, see you soon!"<<endl;
                    string phrase = "Good Bye Master Birbal, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
		...
		else
		{
            ...
            string phrase = "This is incorrect Password, please enter correct password";
            string command = "espeak \"" + phrase + "\"";
            const char *charCommand = command.c_str();
            system(charCommand);
		}
